...
- `VISION/09-Roadmap/Phase-3-Connectors.md` checklists now reflect the landed work (F1–F13, C1–C7, A1–A4, T1–T2) with issue references, the stale "Duration: 6–8 weeks" header is replaced by a status blockquote pointing at `Phase-3-Plan.md` as the tracking doc, and the success criteria / risks sections note how each was met or mitigated.
