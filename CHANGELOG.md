...
- Tests: 27 wizard tests covering every email and calendar preset (endpoint/scope/IMAP defaults, auth ordering, sync questions), legacy-alias registration, enum wire-contract and discriminant-stability tests, migration seed test, and updated CLI/e2e/server/migrations suites.
