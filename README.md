...
- **Knowledge Graph** — Live memory condensation, entity/fact storage, temporal reasoning, relationship type DAG + aliases, and event-driven regeneration via the unified background scheduler
