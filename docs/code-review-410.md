...
| Security | User-controlled category names could contain line breaks and other control whitespace that break prompt structure. | Medium | Normalised runs of Unicode whitespace while rendering category names, and filed #599 for stronger boundary validation. |
