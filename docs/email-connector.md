...
- **`LodgingReservation`** → `user has_booking <hotel>` (Event, `Appointment`, temporal = checkin → checkout), `<booking> located_in <hotel address>` (Place).
