...
1. **KG-focused base** (`build_base_prompt`) — extraction rules, category taxonomy (Categorisation Guide), predicate standards, list splitting, within-output deduplication, and the output contract. Shared with the simple `extract_facts` path.
