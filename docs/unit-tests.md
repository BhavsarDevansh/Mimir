...
- `daemon_guard.rs`: 12 tests — the auto-start guard's HTTP and Unix-socket probes, prompt, spawn, injectable timeout (including slow-probe capping), and child-env secret-stripping paths.
