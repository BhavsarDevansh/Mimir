...
- Tag facts with the **most specific** subcategory available at extraction time (the extraction prompt renders the complete assignable category tree and instructs the LLM to assign 1–3 valid category ids; synthetic Root is structural and excluded).
