...
- **OS keyring backend** — an optional OS keyring (macOS Keychain / Linux Secret Service / Windows Credential Manager) for connector secrets, tracked as a follow-up (#188).
