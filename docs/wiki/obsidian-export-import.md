...
- **Large imports:** repeated shared objects use a per-import cache, and dry-run follows the same relationship-aware object resolution as apply, so counts stay predictable on multi-file vaults.
