...
-- resolution. Idempotent via INSERT OR IGNORE.
PRAGMA foreign_keys = OFF;

-- 1. Canonical verbs (explicit ids 26-31; 1-25 are taken by earlier migrations).
INSERT OR IGNORE INTO relationship_types (id, name, description) VALUES
...
-- 2. Self-aliases for the new canonical verbs.
