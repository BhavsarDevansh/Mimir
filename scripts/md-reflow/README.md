...
Directory walks skip `target/`, `.git/` and `vendor/`: vendored third-party crates keep their upstream formatting and are not subject to the repo's single-line prose rules (issue #446).
