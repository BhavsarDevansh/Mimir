...
// Mimir vendor patch (issue #446): the extern crate item must be public.
// rustc future-incompat lint E0365 rejects re-exporting a private extern
// crate (`pub use proc_macro;` below) and will make it a hard error on a
// future toolchain; upstream has no fixed release (last crates.io release
// 2024-09).
